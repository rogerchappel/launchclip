...
`;
  const renderPlan = {
    ...
    adapters: {
      ...
      hyperframes: "Open video/hyperframes/index.html with HyperFrames. Check video/hyperframes/template-qa.html and video/hyperframes/sfx-manifest.json for reusable object coverage, lifecycle gaps, and SFX hooks before linting, previewing, and rendering.",
...
Open \`template-qa.html\` before render review to inspect reusable object family coverage, lifecycle state gaps, text-fit risk, and object-level SFX hooks. Use \`sfx-manifest.json\` to map lifecycle SFX names to reusable local audio assets and timed cue events.
