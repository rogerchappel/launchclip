...
Open \`template-qa.html\` before render review to inspect reusable object family coverage, lifecycle state gaps, text-fit risk, and object-level SFX hooks. Use \`asset-readiness.html\` to review real, missing, and placeholder visual/audio assets. Use \`sfx-manifest.json\` to map lifecycle SFX names to reusable local audio assets and timed cue events.
