...
`;
  const renderPlan = {
    ...
    adapters: {
      ...
      hyperframes: "Open video/hyperframes/index.html with HyperFrames. Check video/hyperframes/template-qa.html, video/hyperframes/chart-diagram-qa.html, and video/hyperframes/sfx-manifest.json for reusable object coverage, lifecycle gaps, chart/diagram evidence, and SFX hooks before linting, previewing, and rendering.",
