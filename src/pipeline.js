...
`;
  const renderPlan = {
    ...
    adapters: {
      ...
      hyperframes: "Open video/hyperframes/index.html with HyperFrames. Check video/hyperframes/template-qa.html for reusable object coverage, lifecycle gaps, and SFX hooks before linting, previewing, and rendering.",
...
Open \`template-qa.html\` before render review to inspect reusable object family coverage, lifecycle state gaps, text-fit risk, and object-level SFX hooks.
