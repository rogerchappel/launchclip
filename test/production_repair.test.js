    ...
    createClient: () => ({
      ...
      runStructured: async (request) => {
        ...
        return {
          ...
          status: "completed",
          usage: {},
          value: framePatch("shot-2", "Proof", "Scoped proof")
        };
      }
    })
  });
